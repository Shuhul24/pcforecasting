...
class KittiOdometryRaw(Dataset):
    ...
    def __init__(self, cfg, split):
        ...
        self.raw_data_path = self.cfg["DATA_CONFIG"].get("RAW_PATH", "/DATA/vishwesh/kitti/dataset/sequences")
        ...
        self.idx_mapper = {}
        idx = 0
        self.precompute_dir = os.path.join('/DATA/soham/robotics/kitti/processed', "precomputed_forecasts")
